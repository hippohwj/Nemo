...
if __name__ == "__main__":
    ...
    if not os.path.exists(out_dir):
        os.makedirs(out_dir)
    exp_name = "exp_point_100m_tuple_varybuf_rw_record"
    config = {
    ...
    db_config = {
        ...
        "g_num_evict_thds": 1,
        "g_batch_eviction_period_ms": 20,
        "g_evict_threshold": 0.9,
        "g_record_size": 1008
    }
...
# set cosmos capacity at 20000 when read_prec = 0.5 and buf_sz = 0.1 for page baseline
    for exp in exps:
        ...
        trial_id = "azure16k-tuple-buf{}-read{}-zipf{}-recordsz{}".format(exp[0], exp[1], exp[2], exp[4])
