...
if __name__ == "__main__":
    ...
    if not os.path.exists(out_dir):
        os.makedirs(out_dir)
    exp_name = "exp_phantomprotection_100m_varybuf_phantomnext_debug"
    config = {
    ...
    db_config = {
        ...
        # "g_num_worker_threads": 200,
        "g_num_worker_threads": 10,
        ...
        "g_enable_log": False,
        # "g_scan_workload_rw_thd_num": 195,
    }
