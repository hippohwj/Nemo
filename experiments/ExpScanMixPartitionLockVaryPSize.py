...
if __name__ == "__main__":
    ...
    exp_name = "exp_mix_scan_partition_lock_vary_psize"
    config = {
    ...
    #   for pt_sz in [1000, 10000, 50000]:
      for pt_sz in [100000, 10000, 1000, 10, 1]:
    #   for pt_sz in [10]:
        exps.append([buf_sz, pt_sz])
    ...
    for exp in exps:
        ...
        trial_id = "azure16k-tuple-buf{}-ps{}".format(exp[0], exp[1])
