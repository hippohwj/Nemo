...
if __name__ == "__main__":
    ...
    if not os.path.exists(out_dir):
        os.makedirs(out_dir)
    exp_name = "negativepoint_page_varydomain_015buffer_skew_debug"
    config = {
    ...
    for exp in exps:     
        ...
        trial_id = "azure16k-tuple-zipf{}-domain{}g-negative{}".format(ycsb_config["zipf_theta_"], exp["domain_size"]/1024000, 0)
